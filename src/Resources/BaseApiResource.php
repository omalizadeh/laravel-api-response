...
namespace Omalizadeh\ApiResponse\Resources;
...
{
    protected array|null|object $data;
    ...
    private function setDataCollectionFormat(): void
    {
        if (!is_countable($this->data)) {
            throw new InvalidArgumentException('given resource collection data is not countable.');
        }
